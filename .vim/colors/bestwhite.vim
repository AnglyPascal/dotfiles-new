...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Normal         guifg=#000000 guibg=#ECEFF4 guisp=NONE gui=NONE      cterm=NONE
  hi None           guifg=#000000 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi CursorLineNr   guifg=#000000 guibg=#26262b guisp=NONE gui=NONE      cterm=NONE
  hi MatchWord      guifg=#000000 guibg=#0f5bca guisp=NONE gui=NONE      cterm=NONE
  hi Pmenu          guifg=#000000 guibg=#34353b guisp=NONE gui=NONE      cterm=NONE
  hi PmenuSel       guifg=#000000 guibg=#0f5bca guisp=NONE gui=NONE      cterm=NONE
  hi QuickFixLine   guifg=#000000 guibg=#0f5bca guisp=NONE gui=NONE      cterm=NONE
  hi StatusLine     guifg=#000000 guibg=#43454b guisp=NONE gui=NONE      cterm=NONE
  hi WildMenu       guifg=#000000 guibg=#0f5bca guisp=NONE gui=NONE      cterm=NONE
  hi Search         guifg=#000000 guibg=#43454b guisp=NONE gui=NONE      cterm=NONE
  ...
  hi EndOfBuffer    guifg=#ECEFF4 guibg=#ECEFF4 guisp=NONE gui=NONE      cterm=NONE
  hi Cursor         guifg=#000000 guibg=#ECEFF4 guisp=NONE gui=NONE      cterm=NONE
  ...
  hi IncSearch      guifg=#ECEFF4 guibg=#fef937 guisp=NONE gui=NONE      cterm=NONE
  ...
  hi Error          guifg=#ECEFF4 guibg=#ff8a7a guisp=NONE gui=NONE      cterm=NONE
  hi PreProc        guifg=#99732b guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi PreProcNoBold  guifg=#99732b guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi Special        guifg=#3D84B8 guibg=NONE    guisp=NONE gui=bold      cterm=bold
  hi Statement      guifg=#558776 guibg=NONE    guisp=NONE gui=bold      cterm=bold
  hi Character      guifg=#d9c668 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi Directory      guifg=#8fbcbb guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi Number         guifg=#2C5965 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi SpecialComment guifg=#aeb7c0 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi String         guifg=#874D47 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  ...
  hi Underlined     guifg=#2C5965 guibg=NONE    guisp=NONE gui=underline cterm=underline
  ...
  " "" LaTeX
  " hi texMathCmd guifg=#5e81ac guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  " hi texCmd guifg=#bf616a guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=None
  " hi texCmdPart guifg=#bf616a guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=Bold
  " hi texEnvOpt guifg=#b1faeb guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  " hi! link texCmdEnv texCmdPart
  " hi! link texMathCmdEnv texMathCmd
  ...
  if g:bestwhite_emph_types
    ...
    hi LocalType guifg=#588490 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#D96098 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  if g:bestwhite_emph_funcs
    ...
    hi LibraryFunc guifg=#2C5965 guibg=NONE guisp=NONE gui=NONE cterm=bold
    hi LibraryFuncRegular guifg=#2C5965 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    ...
    hi LibraryFunc guifg=#2A496F guibg=NONE guisp=NONE gui=NONE cterm=bold
    hi LibraryFuncRegular guifg=#2A496F guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:bestwhite_emph_idents
    ...
    hi LocalIdent guifg=#bebe8c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#cda1ff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:bestwhite_match_paren_style
    hi MatchParen guifg=#17171c guibg=#fef937 guisp=NONE gui=NONE cterm=NONE
  else
...
if s:t_Co >= 256
  ...
  if g:bestwhite_emph_funcs
    ...
    hi LibraryFunc ctermfg=225 ctermbg=NONE cterm=bold
  else
    hi FunctionDef ctermfg=81 ctermbg=NONE cterm=NONE
    hi LocalFunc ctermfg=116 ctermbg=NONE cterm=NONE
    hi LibraryFunc ctermfg=183 ctermbg=NONE cterm=bold
  endif
  if g:bestwhite_emph_idents
