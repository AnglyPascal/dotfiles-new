...
Config.instname = "University of Oxford"
Config.profilename = "Oxford Users"
Config.url = "https://help.it.ox.ac.uk/access-wifi-eduroam"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.server_match = "oucs.ox.ac.uk"
...
Config.user_realm = "OX.AC.UK"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.oucs.ox.ac.uk', 'DNS:radius0.oucs.ox.ac.uk', 'DNS:radius1.oucs.ox.ac.uk', 'DNS:radius2.oucs.ox.ac.uk']
Config.use_other_tls_id = False
Config.anonymous_identity = "__entrust__20210521@OX.AC.UK"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = """Eduroam is an international federation of academic institutions which allows its users to visit other organizations and use the same username and password as they would use at their home institution.

Eduroam institutions span Europe, Asia-Pacific, Canada, and the USA.

Oxford users

Oxford users can use eduroam in Oxford and at other participating organizations.

Oxford eduroam uses the IT Services Remote Access account username and password.

Oxford users should ensure that their eduroam setup is working correctly in Oxford before visiting other eduroam institutions.

Oxford visitors

Oxford eduroam implements JANET Roaming Service Tier 2.

IT Services are unable to provide technical support to non-Oxford eduroam users visiting Oxford.

Firewall restrictions

A small number of outbound ports are blocked. See the ACL blocks page for the current list. """
