...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if !exists('g:bestblack_green_comments')
    let g:bestblack_green_comments = 0
  endif
  if !exists('g:bestblack_emph_types')
    let g:bestblack_emph_types = 1
  endif
  if !exists('g:bestblack_emph_funcs')
    let g:bestblack_emph_funcs = 0
  endif
  if !exists('g:bestblack_emph_idents')
    let g:bestblack_emph_idents = 0
  endif
  if !exists('g:bestblack_match_paren_style')
    let g:bestblack_match_paren_style = 0
  endif
  if !exists('g:bestblack_dim_punctuation')
    let g:bestblack_dim_punctuation = 1
  endif

  hi Normal         guifg=#ffffff guibg=#17171c guisp=NONE gui=NONE      cterm=NONE
  ...
  hi EndOfBuffer    guifg=#17171c guibg=#17171c guisp=NONE gui=NONE      cterm=NONE
  hi Cursor         guifg=#17171c guibg=#ffffff guisp=NONE gui=NONE      cterm=NONE
  ...
  hi ALEWarningSign guifg=#ffa14f guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  ...
  hi PreProcNoBold  guifg=#ebcb8b guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi Special        guifg=#88c0d0 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  hi Statement      guifg=#a3be8c guibg=NONE    guisp=NONE gui=bold      cterm=bold
  ...
  hi String         guifg=#e4b8e6 guibg=NONE    guisp=NONE gui=NONE      cterm=NONE
  ...
  hi Underlined     guifg=#88c0d0 guibg=NONE    guisp=NONE gui=underline cterm=underline
  ...
  if g:bestblack_emph_types
    ...
    hi LibraryType guifg=#b48e9c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:bestblack_emph_funcs
    ...
    hi LibraryFunc guifg=#88c0d0 guibg=NONE guisp=NONE gui=NONE cterm=bold
    hi LibraryFuncRegular guifg=#88c0d0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    ...
    hi LibraryFunc guifg=#88c1d1 guibg=NONE guisp=NONE gui=NONE cterm=bold
    hi LibraryFuncRegular guifg=#88c1d1 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:bestblack_emph_idents
  ...
  if g:bestblack_match_paren_style
    hi MatchParen guifg=#17171c guibg=#ebcb8b guisp=NONE gui=NONE cterm=NONE
  else
    hi MatchParen guifg=#ffffff guibg=#88c0d0 guisp=NONE gui=NONE cterm=NONE
  endif
  if g:bestblack_dim_punctuation
