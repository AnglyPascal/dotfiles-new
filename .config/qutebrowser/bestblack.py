...
## Type: QssColor
c.colors.completion.category.bg = nord['bestb']

## Bottom border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.bottom = nord['bestb']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.top = nord['bestb']
...
## Type: QssColor
c.colors.completion.even.bg = nord['bestb']

## Background color of the completion widget for odd rows.
## Type: QssColor
c.colors.completion.odd.bg = nord['bestb']
...
## Type: QssColor
c.colors.completion.item.selected.bg = nord['nord2']

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = nord['nord2']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = nord['nord2']
...
## Type: QssColor
c.colors.completion.scrollbar.bg = nord['bestb']
...
## Type: QssColor
c.colors.downloads.bar.bg = nord['bestb']
...
## Type: QssColor
c.colors.hints.fg = nord['bestb']

## Font color for the matched part of hints.
## Type: QssColor
c.colors.hints.match.fg = nord['nord14']
...
# ## Type: String
c.colors.prompts.border = '1px solid ' + nord['bestb']
...
## Type: QssColor
c.colors.statusbar.command.bg = nord['bestb']
...
## Type: QssColor
c.colors.statusbar.command.private.bg = '#4a2142' #nord['nord2']
...
## Type: QssColor
c.colors.statusbar.insert.fg = nord['bestb']

## Background color of the statusbar.
## Type: QssColor
c.colors.statusbar.normal.bg = nord['bestb']
...
## Type: QssColor
c.colors.statusbar.private.bg = '#4a2142' # nord['nord15']
...
## Type: QssColor
c.colors.statusbar.progress.bg = nord['nord3']
...
## Colors of unselected tabs.
## Type: QtColor
c.colors.tabs.even.bg = nord['bestb']
c.colors.tabs.even.fg = nord['nord5']
c.colors.tabs.odd.bg = nord['bestb']
c.colors.tabs.odd.fg = nord['nord5']

c.colors.tabs.pinned.even.bg = nord['bestb']
c.colors.tabs.pinned.even.fg = nord['nord5']
c.colors.tabs.pinned.odd.bg = nord['bestb']
...
# ## Colors of of selected tabs.
# ## Type: QtColor
c.colors.tabs.selected.even.bg = nord['nord14']
c.colors.tabs.selected.even.fg = nord['bestb']
c.colors.tabs.selected.odd.bg = nord['nord14']
c.colors.tabs.selected.odd.fg = nord['bestb']

c.colors.tabs.pinned.selected.even.bg = nord['nord14']
c.colors.tabs.pinned.selected.even.fg = nord['bestb']
c.colors.tabs.pinned.selected.odd.bg = nord['nord14']
c.colors.tabs.pinned.selected.odd.fg = nord['bestb']
